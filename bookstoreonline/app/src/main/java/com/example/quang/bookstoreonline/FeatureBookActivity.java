...
public class FeatureBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        featureBook.add(new FeatureBookModel("Đắc nhân tâm", "150.000", "First New", R.drawable.dacnhantam,R.drawable.giohang));
        featureBook.add(new FeatureBookModel("Quà tặng diệu kỳ", "150.000", "First New", R.drawable.quatang2,R.drawable.giohang));
        featureBook.add(new FeatureBookModel("Bí mật của may mắn", "80.000", "First New", R.drawable.bimat,R.drawable.giohang));
